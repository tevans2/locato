...
export const MAP_TAP_LOCATIONS: readonly MapTapLocation[] = [
  ...
  { id: "andes-central", name: "The Andes", category: "mountain-range", lat: -32.6532, lng: -70.0112, difficulty: "medium", wikiSlug: "Andes", toleranceKm: 900, anchors: [{ lat: 4.5, lng: -73.5 }, { lat: -13.0, lng: -72.0 }, { lat: -45.0, lng: -71.5 }] },
  ...
  { id: "rocky-mountains", name: "The Rocky Mountains", category: "mountain-range", lat: 39.7392, lng: -105.9903, difficulty: "hard", wikiSlug: "Rocky_Mountains", toleranceKm: 800, anchors: [{ lat: 51.4, lng: -116.2 }, { lat: 43.6, lng: -110.7 }, { lat: 35.8, lng: -106.0 }] },
  { id: "atlas-mountains", name: "Atlas Mountains", category: "mountain-range", lat: 31.0594, lng: -7.9159, difficulty: "hard", wikiSlug: "Atlas_Mountains", toleranceKm: 400, anchors: [{ lat: 36.0, lng: -4.0 }, { lat: 27.5, lng: -10.5 }] },
  { id: "drakensberg", name: "Drakensberg", category: "mountain-range", lat: -29.3833, lng: 29.45, difficulty: "hard", wikiSlug: "Drakensberg", toleranceKm: 300 },
